...
func main() {
	var (
		...
		checkKeyGroupsRunIntervalSecs = flag.Int64("check-key-groups-run-interval-secs", getEnvInt64("REDIS_EXPORTER_CHECK_KEY_GROUPS_RUN_INTERVAL_SECS", 600), "Time in Seconds for interval between successive runs of key group script")
	...
	exp, err := exporter.NewRedisExporter(
		*redisAddr,
		exporter.Options{
			...
			CheckKeyGroupsRunIntervalSecs: *checkKeyGroupsRunIntervalSecs,
