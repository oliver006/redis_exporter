...
func TestParseClientListString(t *testing.T) {
	...
	tsts := []struct {
	...
	}{
		{
			...
			expectedOk:   true,
			expectedInfo: ClientInfo{Id: "11", CreatedAt: convertDurationToTimestampInt64("6321"), IdleSince: convertDurationToTimestampInt64("6320"), IdleSeconds: 6320, Flags: "N", Db: "0", Ssub: -1, Watch: -1, Obl: 3, Oll: 8, OMem: 0, TotMem: 0, Host: "127.0.0.1", Port: "63508"},
		}, {
			...
			expectedOk:   true,
			expectedInfo: ClientInfo{Id: "14", Name: "foo", CreatedAt: convertDurationToTimestampInt64("5"), IdleSince: convertDurationToTimestampInt64("0"), IdleSeconds: 0, Flags: "N", Db: "1", Ssub: -1, Watch: -1, Qbuf: 26, QbufFree: 32742, OMem: 0, TotMem: 0, Host: "127.0.0.1", Port: "64958"},
		}, {
			...
			expectedOk:   true,
			expectedInfo: ClientInfo{Id: "14", CreatedAt: convertDurationToTimestampInt64("5"), IdleSince: convertDurationToTimestampInt64("0"), IdleSeconds: 0, Flags: "N", Db: "0", Ssub: -1, Watch: -1, Qbuf: 26, QbufFree: 32742, OMem: 0, TotMem: 0, Host: "127.0.0.1", Port: "64959", User: "default", Resp: "3"},
		}, {
			...
			expectedOk:   true,
			expectedInfo: ClientInfo{Id: "40253233", CreatedAt: convertDurationToTimestampInt64("782"), IdleSince: convertDurationToTimestampInt64("0"), IdleSeconds: 0, Flags: "N", Db: "0", Sub: 896, Psub: 18, Ssub: 17, Watch: 3, Qbuf: 26, QbufFree: 32742, Oll: 555, OMem: 0, TotMem: 61466, Host: "fd40:1481:21:dbe0:7021:300:a03:1a06", Port: "44426", User: "default"},
		}, {
	...
	for _, tst := range []struct {
		...
		t.Run(tst.name, func(t *testing.T) {
			...
			for m := range chM {
				...
				if !strings.Contains(desc, "client_connections_idle") {
					continue
				}
			...
			if foundIdleMetric != tst.wantIdleMetric {
				t.Fatalf("client_connections_idle presence = %v, want %v", foundIdleMetric, tst.wantIdleMetric)
			}
			if tst.wantIdleMetric && idleCount != tst.wantIdleCount {
				t.Fatalf("client_connections_idle = %v, want %v", idleCount, tst.wantIdleCount)
			}
