...
func TestExtractSearchIndexesMetrics(t *testing.T) {
	...
	for _, tst := range tsts {
		...
		wantedMetrics := map[string]bool{
			...
			"search_index_records_per_doc_avg":           false,
			"search_index_bytes_per_record_avg":          false,
			"search_index_offsets_per_term_avg":          false,
			"search_index_offset_bits_per_record_avg":    false,
