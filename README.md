...
| append-instance-role-label          | REDIS_APPEND_INSTANCE_ROLE_LABEL                 | Whether to append 'instance_role' label to all exporter metrics. It allows easy creation of dashboards/alerts with a selector for instance role (master/replica). NOTE: This increases the cardinality of Redis metrics.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
