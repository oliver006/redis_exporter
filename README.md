...
| redact-config-metrics               | REDIS_EXPORTER_REDACT_CONFIG_METRICS             | Whether to also redact non-secret but sensitive config settings such as usernames (defaults to true). Credentials like passwords are always redacted regardless of this setting, so they can never be read from the metrics endpoint.                                                                                                                                                                                                                                                                                                                                                                                                              |
